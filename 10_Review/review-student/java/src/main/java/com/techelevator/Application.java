...
public class Application {
    ...
    private void printEmployees() {
        ...
        for (Employee employeeTemp : employees) {
            ...
            System.out.println(employeeTemp.getFullName() + " (" + employeeTemp.getSalary() + ") "
                    + employeeTemp.getDepartment().getName() );
        }
    }
    ...
    private void createLandingPageProject() {
        Project projectTwo = new Project("Marketing Landing Page",
